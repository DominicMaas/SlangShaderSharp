...
public partial interface IModule : IComponentType
{
    ...
    /// </summary>
    [PreserveSig]
    int FindEntryPointByName([MarshalAs(UnmanagedType.LPUTF8Str)] string name, out IEntryPoint entryPoint);
    ...
    /// <returns></returns>
    [PreserveSig]
    int GetDefinedEntryPoint(int index, out IEntryPoint entryPoint);
